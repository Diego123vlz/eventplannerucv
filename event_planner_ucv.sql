...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-06-2022 a las 15:48:09
...
--
-- Base de datos: `event planner ucv`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lneu3_action_logs`
--

CREATE TABLE `lneu3_action_logs` (
...
--
-- Volcado de datos para la tabla `lneu3_action_logs`
--

INSERT INTO `lneu3_action_logs` (`id`, `message_language_key`, `message`, `log_date`, `extension`, `user_id`, `item_id`, `ip_address`) VALUES
(1, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":527,\"username\":\"Diego Velazque\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=527\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE\"}', '2022-05-24 06:02:15', 'com_users', 527, 0, 'COM_ACTIONLOGS_DISABLED'),
(2, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_OUT', '{\"action\":\"logout\",\"id\":527,\"userid\":527,\"username\":\"Diego Velazque\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=527\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE\"}', '2022-05-24 06:02:53', 'com_users', 527, 527, 'COM_ACTIONLOGS_DISABLED'),
(3, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":527,\"username\":\"Diego Velazque\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=527\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE\"}', '2022-05-24 06:03:06', 'com_users', 527, 0, 'COM_ACTIONLOGS_DISABLED'),
(4, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_UPDATED', '{\"action\":\"update\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_MODULE\",\"id\":17,\"title\":\"Event Planner UCV\",\"extension_name\":\"Event Planner UCV\",\"itemlink\":\"index.php?option=com_modules&task=module.edit&id=17\",\"userid\":527,\"username\":\"Diego Velazque\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=527\"}', '2022-05-24 06:05:11', 'com_modules.module', 527, 17, 'COM_ACTIONLOGS_DISABLED');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lneu3_action_logs_extensions`
--

CREATE TABLE `lneu3_action_logs_extensions` (
  `id` int(10) UNSIGNED NOT NULL,
  `extension` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `lneu3_action_logs_extensions`
--

INSERT INTO `lneu3_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Estructura de tabla para la tabla `lneu3_action_logs_users`
--

CREATE TABLE `lneu3_action_logs_users` (
...
--
-- Estructura de tabla para la tabla `lneu3_action_log_config`
--

CREATE TABLE `lneu3_action_log_config` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Volcado de datos para la tabla `lneu3_action_log_config`
--

INSERT INTO `lneu3_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Estructura de tabla para la tabla `lneu3_assets`
--

CREATE TABLE `lneu3_assets` (
...
--
-- Volcado de datos para la tabla `lneu3_assets`
--

INSERT INTO `lneu3_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(51, 18, 84, 85, 2, 'com_modules.module.17', 'Event Planner UCV', '{}'),
...
--
-- Estructura de tabla para la tabla `lneu3_associations`
--

CREATE TABLE `lneu3_associations` (
...
--
-- Estructura de tabla para la tabla `lneu3_banners`
--

CREATE TABLE `lneu3_banners` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `lneu3_banner_clients`
--

CREATE TABLE `lneu3_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `lneu3_banner_tracks`
--

CREATE TABLE `lneu3_banner_tracks` (
...
--
-- Estructura de tabla para la tabla `lneu3_categories`
--

CREATE TABLE `lneu3_categories` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `lneu3_categories`
--

INSERT INTO `lneu3_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, NULL, NULL, 1, '{}', '', '', '{}', 527, '2022-05-24 05:58:48', 527, '2022-05-24 05:58:48', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\",\"workflow_id\":\"use_default\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 527, '2022-05-24 05:58:48', 527, '2022-05-24 05:58:48', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 527, '2022-05-24 05:58:48', 527, '2022-05-24 05:58:48', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 527, '2022-05-24 05:58:48', 527, '2022-05-24 05:58:48', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 527, '2022-05-24 05:58:48', 527, '2022-05-24 05:58:48', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 527, '2022-05-24 05:58:48', 527, '2022-05-24 05:58:48', 0, '*', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lneu3_contact_details`
--

CREATE TABLE `lneu3_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `lneu3_content`
--

CREATE TABLE `lneu3_content` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `lneu3_contentitem_tag_map`
--

CREATE TABLE `lneu3_contentitem_tag_map` (
  `type_alias` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `lneu3_content_frontpage`
--

CREATE TABLE `lneu3_content_frontpage` (
...
--
-- Estructura de tabla para la tabla `lneu3_content_rating`
--

CREATE TABLE `lneu3_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT 0,
...
--
-- Estructura de tabla para la tabla `lneu3_content_types`
--

CREATE TABLE `lneu3_content_types` (
...
--
-- Volcado de datos para la tabla `lneu3_content_types`
--

INSERT INTO `lneu3_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Estructura de tabla para la tabla `lneu3_extensions`
--

CREATE TABLE `lneu3_extensions` (
...
--
-- Volcado de datos para la tabla `lneu3_extensions`
--

INSERT INTO `lneu3_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `changelogurl`, `folder`, `client_id`, `enabled`, `access`, `protected`, `locked`, `manifest_cache`, `params`, `custom_data`, `checked_out`, `checked_out_time`, `ordering`, `state`, `note`) VALUES
...
(36, 0, 'lib_joomla', 'library', 'joomla', NULL, '', 0, 1, 1, 1, 1, '{\"name\":\"lib_joomla\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2008 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}', '{\"mediaversion\":\"6c43600edf398d6061059b11e243b6ec\"}', '', NULL, NULL, 0, 0, NULL),
...
(185, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', NULL, 'system', 0, 1, 1, 0, 1, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2015 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1653372069}', '', NULL, NULL, 23, 0, NULL),
...
--
-- Estructura de tabla para la tabla `lneu3_fields`
--

CREATE TABLE `lneu3_fields` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `lneu3_fields_categories`
--

CREATE TABLE `lneu3_fields_categories` (
...
--
-- Estructura de tabla para la tabla `lneu3_fields_groups`
--

CREATE TABLE `lneu3_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `lneu3_fields_values`
--

CREATE TABLE `lneu3_fields_values` (
...
--
-- Estructura de tabla para la tabla `lneu3_finder_filters`
--

CREATE TABLE `lneu3_finder_filters` (
...
--
-- Estructura de tabla para la tabla `lneu3_finder_links`
--

CREATE TABLE `lneu3_finder_links` (
...
--
-- Estructura de tabla para la tabla `lneu3_finder_links_terms`
--

CREATE TABLE `lneu3_finder_links_terms` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `lneu3_finder_logging`
--

CREATE TABLE `lneu3_finder_logging` (
...
--
-- Estructura de tabla para la tabla `lneu3_finder_taxonomy`
--

CREATE TABLE `lneu3_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `lft` int(11) NOT NULL DEFAULT 0,
  `rgt` int(11) NOT NULL DEFAULT 0,
...
--
-- Volcado de datos para la tabla `lneu3_finder_taxonomy`
--

INSERT INTO `lneu3_finder_taxonomy` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `state`, `access`, `language`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', 1, 1, '*');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lneu3_finder_taxonomy_map`
--

CREATE TABLE `lneu3_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `lneu3_finder_terms`
--

CREATE TABLE `lneu3_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `lneu3_finder_terms_common`
--

CREATE TABLE `lneu3_finder_terms_common` (
...
--
-- Volcado de datos para la tabla `lneu3_finder_terms_common`
--

INSERT INTO `lneu3_finder_terms_common` (`term`, `language`, `custom`) VALUES
('a', 'en', 0),
('about', 'en', 0),
('above', 'en', 0),
('after', 'en', 0),
...
--
-- Estructura de tabla para la tabla `lneu3_finder_tokens`
--

CREATE TABLE `lneu3_finder_tokens` (
  `term` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `stem` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `common` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
  `phrase` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Estructura de tabla para la tabla `lneu3_finder_tokens_aggregate`
--

CREATE TABLE `lneu3_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
  `term` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `stem` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `common` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Estructura de tabla para la tabla `lneu3_finder_types`
--

CREATE TABLE `lneu3_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `lneu3_history`
--

CREATE TABLE `lneu3_history` (
...
--
-- Estructura de tabla para la tabla `lneu3_languages`
--

CREATE TABLE `lneu3_languages` (
...
--
-- Volcado de datos para la tabla `lneu3_languages`
--

INSERT INTO `lneu3_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lneu3_mail_templates`
--

CREATE TABLE `lneu3_mail_templates` (
...
--
-- Volcado de datos para la tabla `lneu3_mail_templates`
--

INSERT INTO `lneu3_mail_templates` (`template_id`, `extension`, `language`, `subject`, `body`, `htmlbody`, `attachments`, `params`) VALUES
...
--
-- Estructura de tabla para la tabla `lneu3_menu`
--

CREATE TABLE `lneu3_menu` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `lneu3_menu`
--

INSERT INTO `lneu3_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`) VALUES
...
--
-- Estructura de tabla para la tabla `lneu3_menu_types`
--

CREATE TABLE `lneu3_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Volcado de datos para la tabla `lneu3_menu_types`
--

INSERT INTO `lneu3_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lneu3_messages`
--

CREATE TABLE `lneu3_messages` (
...
--
-- Estructura de tabla para la tabla `lneu3_messages_cfg`
--

CREATE TABLE `lneu3_messages_cfg` (
...
--
-- Estructura de tabla para la tabla `lneu3_modules`
--

CREATE TABLE `lneu3_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
...
--
-- Volcado de datos para la tabla `lneu3_modules`
--

INSERT INTO `lneu3_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(17, 51, 'Event Planner UCV', '', '', 1, 'banner', NULL, NULL, NULL, NULL, 1, 'mod_breadcrumbs', 1, 1, '{\"showHere\":1,\"showHome\":1,\"homeText\":\"\",\"showLast\":1,\"layout\":\"_:default\",\"moduleclass_sfx\":\"\",\"cache\":0,\"cache_time\":0,\"cachemode\":\"itemid\",\"module_tag\":\"div\",\"bootstrap_size\":\"0\",\"header_tag\":\"h3\",\"header_class\":\"\",\"style\":\"0\"}', 0, '*'),
...
--
-- Estructura de tabla para la tabla `lneu3_modules_menu`
--

CREATE TABLE `lneu3_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT 0,
  `menuid` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `lneu3_modules_menu`
--

INSERT INTO `lneu3_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla `lneu3_newsfeeds`
--

CREATE TABLE `lneu3_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT 0,
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `lneu3_overrider`
--

CREATE TABLE `lneu3_overrider` (
...
--
-- Estructura de tabla para la tabla `lneu3_postinstall_messages`
--

CREATE TABLE `lneu3_postinstall_messages` (
...
--
-- Volcado de datos para la tabla `lneu3_postinstall_messages`
--

INSERT INTO `lneu3_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Estructura de tabla para la tabla `lneu3_privacy_consents`
--

CREATE TABLE `lneu3_privacy_consents` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `state` int(11) NOT NULL DEFAULT 1,
  `created` datetime NOT NULL,
...
--
-- Estructura de tabla para la tabla `lneu3_privacy_requests`
--

CREATE TABLE `lneu3_privacy_requests` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `lneu3_redirect_links`
--

CREATE TABLE `lneu3_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `lneu3_scheduler_tasks`
--

CREATE TABLE `lneu3_scheduler_tasks` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `lneu3_schemas`
--

CREATE TABLE `lneu3_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `lneu3_schemas`
--

INSERT INTO `lneu3_schemas` (`extension_id`, `version_id`) VALUES
(220, '4.1.3-2022-04-08');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lneu3_session`
--

CREATE TABLE `lneu3_session` (
...
--
-- Volcado de datos para la tabla `lneu3_session`
--

INSERT INTO `lneu3_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
(0x6d316b636d326c61716f766d646a6a68383974656a3162396572, 0, 0, 1653372658, 'joomla|s:1456:\"\";', 527, 'Diego Velazque');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lneu3_tags`
--

CREATE TABLE `lneu3_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `lft` int(11) NOT NULL DEFAULT 0,
  `rgt` int(11) NOT NULL DEFAULT 0,
...
--
-- Volcado de datos para la tabla `lneu3_tags`
--

INSERT INTO `lneu3_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, NULL, NULL, 1, '', '', '', '', 527, '2022-05-24 05:58:45', '', 527, '2022-05-24 05:58:45', '', '', 0, '*', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lneu3_template_overrides`
--

CREATE TABLE `lneu3_template_overrides` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `lneu3_template_styles`
--

CREATE TABLE `lneu3_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
  `template` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `client_id` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Volcado de datos para la tabla `lneu3_template_styles`
--

INSERT INTO `lneu3_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `inheritable`, `parent`, `params`) VALUES
...
--
-- Estructura de tabla para la tabla `lneu3_ucm_base`
--

CREATE TABLE `lneu3_ucm_base` (
...
--
-- Estructura de tabla para la tabla `lneu3_ucm_content`
--

CREATE TABLE `lneu3_ucm_content` (
...
--
-- Estructura de tabla para la tabla `lneu3_updates`
--

CREATE TABLE `lneu3_updates` (
...
--
-- Volcado de datos para la tabla `lneu3_updates`
--

INSERT INTO `lneu3_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `changelogurl`, `extra_query`) VALUES
...
(5, 2, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/cs-CZ_details.xml', '', '', ''),
(6, 2, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '4.1.3.1', '', 'https://update.joomla.org/language/details4/da-DK_details.xml', '', '', ''),
(7, 2, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '4.1.3.1', '', 'https://update.joomla.org/language/details4/nl-NL_details.xml', '', '', ''),
(8, 2, 0, 'English, Australia', '', 'pkg_en-AU', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/en-AU_details.xml', '', '', ''),
(9, 2, 0, 'English, Canada', '', 'pkg_en-CA', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/en-CA_details.xml', '', '', ''),
(10, 2, 0, 'English, New Zealand', '', 'pkg_en-NZ', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/en-NZ_details.xml', '', '', ''),
(11, 2, 0, 'English, USA', '', 'pkg_en-US', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/en-US_details.xml', '', '', ''),
(12, 2, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '4.1.0.1', '', 'https://update.joomla.org/language/details4/et-EE_details.xml', '', '', ''),
(13, 2, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '4.1.1.2', '', 'https://update.joomla.org/language/details4/fi-FI_details.xml', '', '', ''),
(14, 2, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '4.1.3.1', '', 'https://update.joomla.org/language/details4/nl-BE_details.xml', '', '', ''),
(15, 2, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '4.1.3.1', '', 'https://update.joomla.org/language/details4/fr-FR_details.xml', '', '', ''),
(16, 2, 0, 'Georgian', '', 'pkg_ka-GE', 'package', '', 0, '4.1.3.1', '', 'https://update.joomla.org/language/details4/ka-GE_details.xml', '', '', ''),
(17, 2, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '4.1.3.2', '', 'https://update.joomla.org/language/details4/de-DE_details.xml', '', '', ''),
(18, 2, 0, 'German, Austria', '', 'pkg_de-AT', 'package', '', 0, '4.1.3.2', '', 'https://update.joomla.org/language/details4/de-AT_details.xml', '', '', ''),
(19, 2, 0, 'German, Liechtenstein', '', 'pkg_de-LI', 'package', '', 0, '4.1.3.2', '', 'https://update.joomla.org/language/details4/de-LI_details.xml', '', '', ''),
(20, 2, 0, 'German, Luxembourg', '', 'pkg_de-LU', 'package', '', 0, '4.1.3.2', '', 'https://update.joomla.org/language/details4/de-LU_details.xml', '', '', ''),
(21, 2, 0, 'German, Switzerland', '', 'pkg_de-CH', 'package', '', 0, '4.1.3.2', '', 'https://update.joomla.org/language/details4/de-CH_details.xml', '', '', ''),
(22, 2, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '4.1.3.1', '', 'https://update.joomla.org/language/details4/el-GR_details.xml', '', '', ''),
(23, 2, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/hu-HU_details.xml', '', '', ''),
(24, 2, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '4.1.3.1', '', 'https://update.joomla.org/language/details4/it-IT_details.xml', '', '', ''),
(25, 2, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '4.1.3.1', '', 'https://update.joomla.org/language/details4/ja-JP_details.xml', '', '', ''),
(26, 2, 0, 'Kazakh', '', 'pkg_kk-KZ', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/kk-KZ_details.xml', '', '', ''),
(27, 2, 0, 'Norwegian Bokmål', '', 'pkg_nb-NO', 'package', '', 0, '4.0.1.1', '', 'https://update.joomla.org/language/details4/nb-NO_details.xml', '', '', ''),
(28, 2, 0, 'Persian Farsi', '', 'pkg_fa-IR', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/fa-IR_details.xml', '', '', ''),
...
(32, 2, 0, 'Romanian', '', 'pkg_ro-RO', 'package', '', 0, '4.1.3.2', '', 'https://update.joomla.org/language/details4/ro-RO_details.xml', '', '', ''),
(33, 2, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '4.1.3.1', '', 'https://update.joomla.org/language/details4/ru-RU_details.xml', '', '', ''),
(34, 2, 0, 'Serbian, Latin', '', 'pkg_sr-RS', 'package', '', 0, '4.1.3.4', '', 'https://update.joomla.org/language/details4/sr-RS_details.xml', '', '', ''),
(35, 2, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '4.0.6.1', '', 'https://update.joomla.org/language/details4/sk-SK_details.xml', '', '', ''),
(36, 2, 0, 'Slovenian', '', 'pkg_sl-SI', 'package', '', 0, '4.1.3.3', '', 'https://update.joomla.org/language/details4/sl-SI_details.xml', '', '', ''),
(37, 2, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '4.1.3.1', '', 'https://update.joomla.org/language/details4/es-ES_details.xml', '', '', ''),
(38, 2, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '4.1.3.1', '', 'https://update.joomla.org/language/details4/sv-SE_details.xml', '', '', ''),
(39, 2, 0, 'Tamil, India', '', 'pkg_ta-IN', 'package', '', 0, '4.1.3.1', '', 'https://update.joomla.org/language/details4/ta-IN_details.xml', '', '', ''),
(40, 2, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '4.1.3.1', '', 'https://update.joomla.org/language/details4/th-TH_details.xml', '', '', ''),
(41, 2, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '4.1.3.1', '', 'https://update.joomla.org/language/details4/tr-TR_details.xml', '', '', ''),
(42, 2, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '4.0.3.2', '', 'https://update.joomla.org/language/details4/uk-UA_details.xml', '', '', ''),
(43, 2, 0, 'Welsh', '', 'pkg_cy-GB', 'package', '', 0, '4.1.3.1', '', 'https://update.joomla.org/language/details4/cy-GB_details.xml', '', '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lneu3_update_sites`
--

CREATE TABLE `lneu3_update_sites` (
...
--
-- Volcado de datos para la tabla `lneu3_update_sites`
--

INSERT INTO `lneu3_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`, `checked_out`, `checked_out_time`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1653372069, '', NULL, NULL),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_4.xml', 1, 1653371949, '', NULL, NULL),
(3, 'Joomla! Update Component', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 0, '', NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lneu3_update_sites_extensions`
--

CREATE TABLE `lneu3_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT 0,
  `extension_id` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Volcado de datos para la tabla `lneu3_update_sites_extensions`
--

INSERT INTO `lneu3_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 220),
(2, 221),
(3, 24);
...
--
-- Estructura de tabla para la tabla `lneu3_usergroups`
--

CREATE TABLE `lneu3_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Volcado de datos para la tabla `lneu3_usergroups`
--

INSERT INTO `lneu3_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Estructura de tabla para la tabla `lneu3_users`
--

CREATE TABLE `lneu3_users` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `lneu3_users`
--

INSERT INTO `lneu3_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`, `authProvider`) VALUES
(527, 'Diego Velazque', 'Diego Velazque', 'daygo.22.vl@gmail.com', '$2y$10$K6TrUsutWxq5eqsDb3QzwO7hr7bYsNlfy6r3hq01ViiZmaS/nqNjm', 0, 1, '2022-05-24 05:59:06', '2022-05-24 06:03:06', '0', '', NULL, 0, '', '', 0, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lneu3_user_keys`
--

CREATE TABLE `lneu3_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Volcado de datos para la tabla `lneu3_user_keys`
--

INSERT INTO `lneu3_user_keys` (`id`, `user_id`, `token`, `series`, `time`, `uastring`) VALUES
(2, 'Diego Velazque', '$2y$10$Fc3UdSRo0ncATSkcWtZLPef7XfEdOrsUDSkyC5SQxXWksKQyteWke', 'YGNSvICB6naKlBApkn7S', '1658556186', 'joomla_remember_me_ddaf5deba6d9d5c98b353f0d46bf76c1');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lneu3_user_notes`
--

CREATE TABLE `lneu3_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `catid` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Estructura de tabla para la tabla `lneu3_user_profiles`
--

CREATE TABLE `lneu3_user_profiles` (
...
--
-- Estructura de tabla para la tabla `lneu3_user_usergroup_map`
--

CREATE TABLE `lneu3_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `lneu3_user_usergroup_map`
--

INSERT INTO `lneu3_user_usergroup_map` (`user_id`, `group_id`) VALUES
(527, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lneu3_viewlevels`
--

CREATE TABLE `lneu3_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT 0,
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Volcado de datos para la tabla `lneu3_viewlevels`
--

INSERT INTO `lneu3_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Estructura de tabla para la tabla `lneu3_webauthn_credentials`
--

CREATE TABLE `lneu3_webauthn_credentials` (
...
--
-- Estructura de tabla para la tabla `lneu3_workflows`
--

CREATE TABLE `lneu3_workflows` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `lneu3_workflows`
--

INSERT INTO `lneu3_workflows` (`id`, `asset_id`, `published`, `title`, `description`, `extension`, `default`, `ordering`, `created`, `created_by`, `modified`, `modified_by`, `checked_out_time`, `checked_out`) VALUES
(1, 56, 1, 'COM_WORKFLOW_BASIC_WORKFLOW', '', 'com_content.article', 1, 1, '2022-05-24 05:58:46', 527, '2022-05-24 05:58:46', 527, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lneu3_workflow_associations`
--

CREATE TABLE `lneu3_workflow_associations` (
...
--
-- Estructura de tabla para la tabla `lneu3_workflow_stages`
--

CREATE TABLE `lneu3_workflow_stages` (
  `id` int(11) NOT NULL,
  `asset_id` int(11) DEFAULT 0,
  `ordering` int(11) NOT NULL DEFAULT 0,
...
--
-- Volcado de datos para la tabla `lneu3_workflow_stages`
--

INSERT INTO `lneu3_workflow_stages` (`id`, `asset_id`, `ordering`, `workflow_id`, `published`, `title`, `description`, `default`, `checked_out_time`, `checked_out`) VALUES
(1, 57, 1, 1, 1, 'COM_WORKFLOW_BASIC_STAGE', '', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lneu3_workflow_transitions`
--

CREATE TABLE `lneu3_workflow_transitions` (
  `id` int(11) NOT NULL,
  `asset_id` int(11) DEFAULT 0,
  `ordering` int(11) NOT NULL DEFAULT 0,
  `workflow_id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `lneu3_workflow_transitions`
--

INSERT INTO `lneu3_workflow_transitions` (`id`, `asset_id`, `ordering`, `workflow_id`, `published`, `title`, `description`, `from_stage_id`, `to_stage_id`, `options`, `checked_out_time`, `checked_out`) VALUES
...
--
-- Indices de la tabla `lneu3_action_logs`
--
ALTER TABLE `lneu3_action_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `lneu3_action_logs_extensions`
--
ALTER TABLE `lneu3_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `lneu3_action_logs_users`
--
ALTER TABLE `lneu3_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Indices de la tabla `lneu3_action_log_config`
--
ALTER TABLE `lneu3_action_log_config`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `lneu3_assets`
--
ALTER TABLE `lneu3_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `lneu3_associations`
--
ALTER TABLE `lneu3_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indices de la tabla `lneu3_banners`
--
ALTER TABLE `lneu3_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `lneu3_banner_clients`
--
ALTER TABLE `lneu3_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indices de la tabla `lneu3_banner_tracks`
--
ALTER TABLE `lneu3_banner_tracks`
...
--
-- Indices de la tabla `lneu3_categories`
--
ALTER TABLE `lneu3_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `lneu3_contact_details`
--
ALTER TABLE `lneu3_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indices de la tabla `lneu3_content`
--
ALTER TABLE `lneu3_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `lneu3_contentitem_tag_map`
--
ALTER TABLE `lneu3_contentitem_tag_map`
...
--
-- Indices de la tabla `lneu3_content_frontpage`
--
ALTER TABLE `lneu3_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `lneu3_content_rating`
--
ALTER TABLE `lneu3_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `lneu3_content_types`
--
ALTER TABLE `lneu3_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indices de la tabla `lneu3_extensions`
--
ALTER TABLE `lneu3_extensions`
...
--
-- Indices de la tabla `lneu3_fields`
--
ALTER TABLE `lneu3_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `lneu3_fields_categories`
--
ALTER TABLE `lneu3_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Indices de la tabla `lneu3_fields_groups`
--
ALTER TABLE `lneu3_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `lneu3_fields_values`
--
ALTER TABLE `lneu3_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Indices de la tabla `lneu3_finder_filters`
--
ALTER TABLE `lneu3_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indices de la tabla `lneu3_finder_links`
--
ALTER TABLE `lneu3_finder_links`
...
--
-- Indices de la tabla `lneu3_finder_links_terms`
--
ALTER TABLE `lneu3_finder_links_terms`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `lneu3_finder_logging`
--
ALTER TABLE `lneu3_finder_logging`
  ADD PRIMARY KEY (`md5sum`),
  ADD KEY `searchterm` (`searchterm`(191));

--
-- Indices de la tabla `lneu3_finder_taxonomy`
--
ALTER TABLE `lneu3_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_state` (`state`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_path` (`path`(100)),
...
--
-- Indices de la tabla `lneu3_finder_taxonomy_map`
--
ALTER TABLE `lneu3_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indices de la tabla `lneu3_finder_terms`
--
ALTER TABLE `lneu3_finder_terms`
...
--
-- Indices de la tabla `lneu3_finder_terms_common`
--
ALTER TABLE `lneu3_finder_terms_common`
  ADD UNIQUE KEY `idx_term_language` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indices de la tabla `lneu3_finder_tokens`
--
ALTER TABLE `lneu3_finder_tokens`
...
--
-- Indices de la tabla `lneu3_finder_tokens_aggregate`
--
ALTER TABLE `lneu3_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indices de la tabla `lneu3_finder_types`
--
ALTER TABLE `lneu3_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indices de la tabla `lneu3_history`
--
ALTER TABLE `lneu3_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indices de la tabla `lneu3_languages`
--
ALTER TABLE `lneu3_languages`
...
--
-- Indices de la tabla `lneu3_mail_templates`
--
ALTER TABLE `lneu3_mail_templates`
  ADD PRIMARY KEY (`template_id`,`language`);

--
-- Indices de la tabla `lneu3_menu`
--
ALTER TABLE `lneu3_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `lneu3_menu_types`
--
ALTER TABLE `lneu3_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indices de la tabla `lneu3_messages`
--
ALTER TABLE `lneu3_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indices de la tabla `lneu3_messages_cfg`
--
ALTER TABLE `lneu3_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indices de la tabla `lneu3_modules`
--
ALTER TABLE `lneu3_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `lneu3_modules_menu`
--
ALTER TABLE `lneu3_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indices de la tabla `lneu3_newsfeeds`
--
ALTER TABLE `lneu3_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indices de la tabla `lneu3_overrider`
--
ALTER TABLE `lneu3_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `lneu3_postinstall_messages`
--
ALTER TABLE `lneu3_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indices de la tabla `lneu3_privacy_consents`
--
ALTER TABLE `lneu3_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Indices de la tabla `lneu3_privacy_requests`
--
ALTER TABLE `lneu3_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `lneu3_redirect_links`
--
ALTER TABLE `lneu3_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modified` (`modified_date`);

--
-- Indices de la tabla `lneu3_scheduler_tasks`
--
ALTER TABLE `lneu3_scheduler_tasks`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `lneu3_schemas`
--
ALTER TABLE `lneu3_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indices de la tabla `lneu3_session`
--
ALTER TABLE `lneu3_session`
...
--
-- Indices de la tabla `lneu3_tags`
--
ALTER TABLE `lneu3_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `lneu3_template_overrides`
--
ALTER TABLE `lneu3_template_overrides`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_extension_id` (`extension_id`);

--
-- Indices de la tabla `lneu3_template_styles`
--
ALTER TABLE `lneu3_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
...
--
-- Indices de la tabla `lneu3_ucm_base`
--
ALTER TABLE `lneu3_ucm_base`
...
--
-- Indices de la tabla `lneu3_ucm_content`
--
ALTER TABLE `lneu3_ucm_content`
...
--
-- Indices de la tabla `lneu3_updates`
--
ALTER TABLE `lneu3_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indices de la tabla `lneu3_update_sites`
--
ALTER TABLE `lneu3_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indices de la tabla `lneu3_update_sites_extensions`
--
ALTER TABLE `lneu3_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indices de la tabla `lneu3_usergroups`
--
ALTER TABLE `lneu3_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `lneu3_users`
--
ALTER TABLE `lneu3_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `lneu3_user_keys`
--
ALTER TABLE `lneu3_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Indices de la tabla `lneu3_user_notes`
--
ALTER TABLE `lneu3_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indices de la tabla `lneu3_user_profiles`
--
ALTER TABLE `lneu3_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indices de la tabla `lneu3_user_usergroup_map`
--
ALTER TABLE `lneu3_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indices de la tabla `lneu3_viewlevels`
--
ALTER TABLE `lneu3_viewlevels`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_assetgroup_title_lookup` (`title`);

--
-- Indices de la tabla `lneu3_webauthn_credentials`
--
ALTER TABLE `lneu3_webauthn_credentials`
  ADD PRIMARY KEY (`id`(100)),
  ADD KEY `user_id` (`user_id`(100));

--
-- Indices de la tabla `lneu3_workflows`
--
ALTER TABLE `lneu3_workflows`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `lneu3_workflow_associations`
--
ALTER TABLE `lneu3_workflow_associations`
...
--
-- Indices de la tabla `lneu3_workflow_stages`
--
ALTER TABLE `lneu3_workflow_stages`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `lneu3_workflow_transitions`
--
ALTER TABLE `lneu3_workflow_transitions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_title` (`title`(191)),
  ADD KEY `idx_asset_id` (`asset_id`),
  ADD KEY `idx_checked_out` (`checked_out`),
...
--
-- AUTO_INCREMENT de la tabla `lneu3_action_logs`
--
ALTER TABLE `lneu3_action_logs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `lneu3_action_logs_extensions`
--
ALTER TABLE `lneu3_action_logs_extensions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `lneu3_action_log_config`
--
ALTER TABLE `lneu3_action_log_config`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT de la tabla `lneu3_assets`
--
ALTER TABLE `lneu3_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=91;

--
-- AUTO_INCREMENT de la tabla `lneu3_banners`
--
ALTER TABLE `lneu3_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_banner_clients`
--
ALTER TABLE `lneu3_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_categories`
--
ALTER TABLE `lneu3_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `lneu3_contact_details`
--
ALTER TABLE `lneu3_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_content`
--
ALTER TABLE `lneu3_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_content_types`
--
ALTER TABLE `lneu3_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;

--
-- AUTO_INCREMENT de la tabla `lneu3_extensions`
--
ALTER TABLE `lneu3_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=225;

--
-- AUTO_INCREMENT de la tabla `lneu3_fields`
--
ALTER TABLE `lneu3_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_fields_groups`
--
ALTER TABLE `lneu3_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_finder_filters`
--
ALTER TABLE `lneu3_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_finder_links`
--
ALTER TABLE `lneu3_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_finder_taxonomy`
--
ALTER TABLE `lneu3_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `lneu3_finder_terms`
--
ALTER TABLE `lneu3_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_finder_types`
--
ALTER TABLE `lneu3_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_history`
--
ALTER TABLE `lneu3_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_languages`
--
ALTER TABLE `lneu3_languages`
  MODIFY `lang_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `lneu3_menu`
--
ALTER TABLE `lneu3_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT de la tabla `lneu3_menu_types`
--
ALTER TABLE `lneu3_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `lneu3_messages`
--
ALTER TABLE `lneu3_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_modules`
--
ALTER TABLE `lneu3_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;

--
-- AUTO_INCREMENT de la tabla `lneu3_newsfeeds`
--
ALTER TABLE `lneu3_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_overrider`
--
ALTER TABLE `lneu3_overrider`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';

--
-- AUTO_INCREMENT de la tabla `lneu3_postinstall_messages`
--
ALTER TABLE `lneu3_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `lneu3_privacy_consents`
--
ALTER TABLE `lneu3_privacy_consents`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_privacy_requests`
--
ALTER TABLE `lneu3_privacy_requests`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_redirect_links`
--
ALTER TABLE `lneu3_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_scheduler_tasks`
--
ALTER TABLE `lneu3_scheduler_tasks`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_tags`
--
ALTER TABLE `lneu3_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `lneu3_template_overrides`
--
ALTER TABLE `lneu3_template_overrides`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_template_styles`
--
ALTER TABLE `lneu3_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `lneu3_ucm_content`
--
ALTER TABLE `lneu3_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_updates`
--
ALTER TABLE `lneu3_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT de la tabla `lneu3_update_sites`
--
ALTER TABLE `lneu3_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `lneu3_usergroups`
--
ALTER TABLE `lneu3_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `lneu3_users`
--
ALTER TABLE `lneu3_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=528;

--
-- AUTO_INCREMENT de la tabla `lneu3_user_keys`
--
ALTER TABLE `lneu3_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `lneu3_user_notes`
--
ALTER TABLE `lneu3_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `lneu3_viewlevels`
--
ALTER TABLE `lneu3_viewlevels`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `lneu3_workflows`
--
ALTER TABLE `lneu3_workflows`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `lneu3_workflow_stages`
--
ALTER TABLE `lneu3_workflow_stages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `lneu3_workflow_transitions`
--
ALTER TABLE `lneu3_workflow_transitions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
